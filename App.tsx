          ...
          <div className="lg:col-span-4 space-y-6 order-2 lg:order-1">
             ...
             >
               <h4 className="font-bold mb-2 flex items-center gap-2">
                 {state.settings.useCustomKey ? <Zap size={16} className="text-amber-500"/> : "💡 تسريع الخدمة"}
                 {state.settings.useCustomKey ? "وضع المفتاح الخاص مفعل" : "نصيحة لتجنب الانتظار"}
               </h4>
               <p className="opacity-80">
                 {state.settings.useCustomKey 
                   ? "أنت تستخدم مفتاحك الخاص (مجاني/مدفوع). هذا يمنحك أولوية في المعالجة."
                   : "أنت تستخدم المفتاح العام المشترك. لتجنب ضغط الخادم، يمكنك إنشاء مفتاح مجاني خاص بك من الإعدادات."
                 }
               </p>
             </div>
          </div>
